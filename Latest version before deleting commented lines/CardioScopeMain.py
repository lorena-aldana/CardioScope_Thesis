...
class cardioscope_gui(QtWidgets.QWidget):
    ...
    def UI(self):
        ...
        #change from real-time to prerecorded:
        ...
        #select sonificaiton types
        # self.btn_selectmarimba.click()
    ...
    def init_plot(self):
        ...
        # self.axecg.set_xticks(np.linspace(0,self.sample_rate), 5)
        self.axecg.set_yticks([-15000, 0, 15000])
        self.axecg.tick_params(axis='both', which='major', labelsize=9)
        # self.axecg.set_xlabel('Time [s]', fontsize=6)
    ...
    def start_pre_recorded_audio_stream(self):
        ...
        # self.timestamp = time.strftime('%b-%d-%Y_%H%M', self.currenttime)
        # self.recfilename = 'rec'+ self.timestamp
        self.recfilename = 'stethoscope_and_ecg_rec_example.wav'
        # path = '/Users/lorenaaldana/sciebo/ecgandsth_data/ecg_and_audio_recs_audacity_44100Hz/Lorena_Rest_040719_160100.wav'
...
class ECGFigure(object):
    def __init__(self, parent):
        # self.main_figure.figure(figsize=(10,6))
        # self.figure = plt.figure(facecolor='white', figsize=(8,4))
        # self.figure = plt.figure(facecolor=(.18, .31, .31), figsize=(8,4))
        self.figure = plt.figure(facecolor='#4da6ff', figsize=(8, 4))
